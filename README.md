...
This project contains the implementations and the test instances used in our article intitled “A rolling horizon approach for the dynamic scheduling of flying taxis”. 
